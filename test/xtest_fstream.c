...
XTEST(stream_let_open_and_close_file) {
    io.mock_file = xmock_file_create("testfile.txt", "");
    ...
    xmock_file_erase(io.mock_file);
}

XTEST(stream_let_write_and_read_file) {
    const char *filename = "testfile.txt";
    const char *content = "This is a test.";
    io.mock_file = xmock_file_create(filename, "");
...
XTEST(stream_let_save_and_reopen_file) {
    const char *filename = "testfile.txt";
...
XTEST(stream_let_seek_within_file) {
    const char *filename = "testfile.txt";
    const char *content = "This is a test.";
    io.mock_file = xmock_file_create(filename, "");
...
// * * * * * * * * * * * * * * * * * * * * * * * *
XTEST_DEFINE_POOL(fossil_logic_fossil_fstream_t_cases) {
