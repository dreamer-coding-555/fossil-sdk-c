...
// * * * * * * * * * * * * * * * * * * * * * * * *
XTEST_DEFINE_POOL(fossil_format_group) {
    XTEST_RUN_UNIT(test_fossil_cstr_format);
    XTEST_RUN_UNIT(test_fossil_bstr_format);
    XTEST_RUN_UNIT(test_fossil_cstr_format_phone);
    XTEST_RUN_UNIT(test_fossil_bstr_format_phone);
    XTEST_RUN_UNIT(test_fossil_cstr_format_date);
    XTEST_RUN_UNIT(test_fossil_bstr_format_date);
    XTEST_RUN_UNIT(test_fossil_cstr_format_time);
    XTEST_RUN_UNIT(test_fossil_bstr_format_time);
    XTEST_RUN_UNIT(test_fossil_cstr_format_currency);
    XTEST_RUN_UNIT(test_fossil_bstr_format_currency);
    XTEST_RUN_UNIT(test_fossil_cstr_format_percentage);
    XTEST_RUN_UNIT(test_fossil_bstr_format_percentage);
    XTEST_RUN_UNIT(test_fossil_cstr_format_postal_code);
    XTEST_RUN_UNIT(test_fossil_bstr_format_postal_code);
    XTEST_RUN_UNIT(test_fossil_cstr_format_ssn);
    XTEST_RUN_UNIT(test_fossil_bstr_format_ssn);
    XTEST_RUN_UNIT(test_fossil_wstr_format);
    XTEST_RUN_UNIT(test_fossil_wstr_format_phone);
    XTEST_RUN_UNIT(test_fossil_wstr_format_date);
    XTEST_RUN_UNIT(test_fossil_wstr_format_time);
    XTEST_RUN_UNIT(test_fossil_wstr_format_currency);
    XTEST_RUN_UNIT(test_fossil_wstr_format_percentage);
    XTEST_RUN_UNIT(test_fossil_wstr_format_postal_code);
    XTEST_RUN_UNIT(test_fossil_wstr_format_ssn);
