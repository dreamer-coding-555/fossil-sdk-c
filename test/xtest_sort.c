...
// * * * * * * * * * * * * * * * * * * * * * * * *
FOSSIL_TEST_GROUP(sort_group) {
    // Run test cases for Bubble Sort
    ADD_TEST(test_sort_bubble_empty_array);
    ADD_TEST(test_sort_bubble_single_element);
    ADD_TEST(test_sort_bubble_multiple_elements);

    // Run test cases for Quick Sort
    ADD_TEST(test_sort_quick_empty_array);
    ADD_TEST(test_sort_quick_single_element);
    ADD_TEST(test_sort_quick_multiple_elements);

    // Run test cases for Merge Sort
    ADD_TEST(test_sort_merge_empty_array);
    ADD_TEST(test_sort_merge_single_element);
    ADD_TEST(test_sort_merge_multiple_elements);

    // Run test case for sorting strings
    ADD_TEST(test_sort_strings);
} // end of fixture
