...
FOSSIL_TEST(test_fossil_cstr_reverse) {
    ...
    ASSUME_ITS_EQUAL_CSTR("olleH", result);
}
...
FOSSIL_TEST(test_fossil_cstr_split) {
    ...
    ASSUME_ITS_EQUAL_CSTR("!", result[2]);
    free(result[0]);
    free(result[1]);
    free(result[2]);
    free(result);
...
FOSSIL_TEST(test_fossil_bstr_copy) {
    ...
    ASSUME_ITS_EQUAL_CSTR("Hello", (cstring)dest);
...
FOSSIL_TEST(test_fossil_bstr_find) {
    ...
    ASSUME_ITS_EQUAL_CSTR(", World!", (cstring)result);
}

FOSSIL_TEST(test_fossil_bstr_split) {
    const_bstring str = (const_bstring)"Hello,World,!";
    bstrings result = fossil_bstr_split(str, ',');
    ASSUME_ITS_EQUAL_CSTR("Hello", (cstring)result[0]);
    ASSUME_ITS_EQUAL_CSTR("World", (cstring)result[1]);
    ASSUME_ITS_EQUAL_CSTR("!", (cstring)result[2]);
