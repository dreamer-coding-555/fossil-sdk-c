 ...
 *
 * Usage:
 *  1. Include "fossil/stdtool/filesystem.h" in your source code.
 ...
 * Example:
 * ```c
 * #include "fossil/stdtool/filesystem.h"
 *
 * int main() {
 ...
 */
fossil_filesystem_t fossil_filesys_create(const char* restrict path);
 ...
 */
void fossil_filesys_create_subdirectory(const fossil_filesystem_t* parent, const char* restrict subfossil_filesys_name);
 ...
 */
void fossil_filesys_remove_file(const fossil_filesystem_t* directory, const char* restrict filename);
 ...
 */
void fossil_filesys_change_directory(fossil_filesystem_t* directory, const char* restrict new_path);
